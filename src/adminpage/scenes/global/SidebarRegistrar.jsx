...
import { BarChartOutlined, MapsUgcOutlined, PieChartOutlined, ViewTimelineOutlined } from "@mui/icons-material";
...
const Sidebar = ({ role, name, privateImage }) => {
  ...
  const sidebarItems = {
    admin: [
      ...
      { title: "Contact Information", to: "contacts", icon: <ContactsOutlinedIcon /> },
    ],
    judge: [
      { title: "Dashboard", to: "", icon: <HomeOutlinedIcon /> },
      { title: "Contact Information", to: "contacts", icon: <ContactsOutlinedIcon /> },
