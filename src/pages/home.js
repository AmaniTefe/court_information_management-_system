...
const Home = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const cardData = [
        {
          title: "በወልቂጤ አካባቢ ከፍተኛ ፍርድ ቤት አቤቱታ መመርመር መስማትና መወሰን ዋና የስራሂደት የሚሰጡ ዋና ዋና አገልግሎቶች",
          text: (
            <>
        ...
        {
          title: "የሃራጌ ዞን ፍትህ መምሪያ የመ/ስ/ማ/ፈውም/ህ/ወ/የስራ ሂደት የሚሰጠውን አገልግሎት ለማግኘት በሚመጡበት ወቅት ማሟላት የሚጠበቅቦት ቅድመ ሁኔታዎ",
          text: (
            <>
              <h5> የ2 ደረጃ ጥብቅና ፍቃድ ለማግኘት የሚያስፈልጉ ቅድመ ሁኔታዎች</h5>
              “በህግ ዲግሪ በሞያው ቢያንስ 1 ዓመት<br />
              - በህግ ዲፕሎማና በሞያው ቢያንስ 2 ዓመት<br />
              - በህግ ሰርተፍኬትና በሞያው ቢያንስ 4 ዓመት<br />
              <h5> ለውክልና፦</h5>
              ባለጉዳይ ወይም ህጋዊ ወኪል በአካል መቅረብ ይኖርበታል ፤የወካይ መታወቂያ ዋናውና ፎቶ ኮፒ ፤በህግ አግባብ የተዚጀ የውክልና ስልጣን መስጫ ሰነድ ብዛት 3 ኮፒ፣ በውክ
              ልናው ላይ በስም ወይም በመለያ ቁጥር ተጠቅሶ የሚቀመጥ ንብረት ካለ የንብረቱ ማስረጃ፤
              የቅርብ ጊዜ ግብር የተከፈለበት ደረሰኝ ፤ የዝምድና ሃረግ ወይም የጋብቻ ሁኔታ የተገለፀ ነገር ካለማስረጃ ማቅረብ ይኖርበታል፡፡
              <h5>ውክልና ለመሻር፦</h5>
              የወካይ ወይም እንዲሽር ስልጣን የተሰጠው አካል መታወቂያ፤ ቀድሞ ተሰጠውን የውክልና ማስረጃ እና የውክልና ይሻርልኝ ማመልከቻ ይዞ መቅረብ አለበት፡፡
              መስተናገድ የሚችለው ውክልናው በተሰጠበት ቦታ ነው፡፡
              ለተለያዩ ውሎች፦
              ተዋዋይ ወገኖች በአካል መቅረብ አለባቸው፤ ከ3 ያላነሱ ምስክሮች በህግ አግባብ የተዘጋጀ የውል ሰነድ ብዛት 3፤ በውል ሰነዱ በደጋፊነት ወይም በአስረጂነት ለሚጠቅሱና ማስረጃ ለሚያስፈልጋቸው ሁሉ የንብረቱ ዋና ማስረጃና ኮፒው መቅረብ ይኖርበታል፡፡ የውል ስ የውል ሰጪ የጋብቻ ሁኔታና ጋብቻ ከሌለ ጋብቻ አለመኖሩን የሚገልፅ 6 ወር ያላለፈው ማስረጃና የውል ሰጪ፤ የውል ተቀባይና የምስክሮች ለዘመኑ የሚያገለግልና የታደሰ መታወቂያ ከነ ኮፒው ይዘው መቅረብ ይኖርባቸዋል፡፡,

            </>
          ),
          imageUrl: "https://www.icrc.org/sites/default/files/styles/document_photo_gallery_detail_file/public/document/image_list/ethiopia-moot-court-ihl-2018-competition-01.jpg?itok=LF7epIOs",
        },

        {
          title: "በወልቂጤ ከተማ የመጀ/ደ/ፍ/ቤት ለመስተናገድ የሚቀርቡ ተገልጋዮች ማሟላት የሚገባቸው አገልግሎቶት ቅድመ ሁኔታዎች",
          text: (
            <>
              <h5>የወንጀል መደበኛ ክስ</h5>
              ➢ክሱ የወንጀል ስነስርዓት ህጉን የተከተለ መሆን አሰበት<br />
              ➢ፍ/ቤቱ ጉዳዩን ስማየት ስልጣን ያስሙ መሆን አስበት<br />
              ➢ክሱ የመንግስት አና የድርጅት ከሆነ ቁጥር ቀን፣ የከሳሽ ፊርማና የተቋሙ ማህተም፤ በግል የሚቀርብ ከሆነ ቀንና ፊርማ ሲሰፍርበት ያስፈልጋል <br />
              ➢ማስረጃ ካስ በክሱ ላይ መጥቀስ አና የሰነድ ማስረጃዎችን ማያያዝ ያስፈልጋል<br />
              ➢ክሱ ስተከሳሾች ሲደርስ በሚችል መልኩ በበቂ ኮፒ መቅረብ አለበት<br />
              <h5>የፍትሐብሔር መደበኛ ክስ</h5>
              ➢ክሱ የፍ/ብሔር/ሥ/ሥ ህጉን የተከተስ መሆን አስበት<br />
              ➢ፍ/ቤቱ ጉዳዩን ስማየት ስልጣን እንዳሰሙ ማመልከት አሰበት<br />
              ➢ከሳሽ ግለሰብ ከሆነ ቀንና ፊርማ ሲሰፍርበት ይገባል<br />
              ➢ከሳሽ መንግስት/ ድርጅት ከሆነ ቀን ቁጥር አና ማህተም ሲኖረው ይገባል <br />
              ➢ማስረጃ ካስ በተሰየ ሠረቀት መጥቀስ አና የሰነድ ማስረጃዎች ማያያዝ እንዲሁም
              ክሱን በቃስ መሃሳ ማረጋገጥ ያስፈልጋል<br />
              ➢ከፍርድ በፊት ንብረት እንዲታገድልኝ በማስት የሚቀርቡ አቤቱታዎች በመሐሳ ቃል በተደገፈ ስዩ ማመልከቻ የፍ/ብ/ሥ/ሥ/ሕ/ቁ 154 ስር የተዘረዘሩት ሁኔታዎች ተሟልተው መገኘታቸውን ማረጋገጥ ያስፈልጋል<br />
              ➢በአፈፃፀም ክስ መነሻነት ንብረት እንዲከበር የሚቀርቡ ማመልከቻዎች የፍ/ብ/ሥ/ሥ/ሕ/ቁ 379 ስር በተመለከቱት ሁኔታዎች መሰረት ተዘጋጅተው መቅረብ አስባቸው<br />
            </>
          ),
